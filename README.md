# Events Validator (Core) - SG opensource

A scalable, serverless solution for real-time JSON event validation. Supports **free cloud deployment** (Supabase + Vercel) or Google Cloud Platform. Validate the quality of any in-app event data before it hits your analytics or marketing destinations.

> 🆓 **NEW: Free Cloud Deployment!** See [FREE_CLOUD_DEPLOYMENT.md](FREE_CLOUD_DEPLOYMENT.md) for zero-cost hosting using Supabase + Vercel.
...
*   **Roadmap**: View the public roadmap on GitHub.
*   **Maintainer**: Maintained by **SG opensource**.
